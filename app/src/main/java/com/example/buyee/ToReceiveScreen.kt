...
@Composable
fun ToReceiveScreen(navController: NavController) {
    Column(modifier = Modifier
        ...
        Row(
            ...
            TopNavButton("To Receive", isSelected = true) {
                // Currently on ToReceiveScreen, no navigation needed
            }
        ...
        Box(
            ...
            Text(
                text = "Orders To Receive",
                fontSize = 24.sp,
                fontWeight = FontWeight.Bold
            )

            // Add your list of items here or any content related to 'To Receive' orders
        }
    }
}
