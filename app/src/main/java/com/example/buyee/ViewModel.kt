//package com.example.buyee//package com.slaviboy.e_commerce_app_ui_compose.viewmodels
//
...
//        return listOf(
//            Product(R.drawable.nikedunk, "Your bag name", 399f, Color(0xFFFB7883)),
//            Product(R.drawable.bag2, "Your bag name", 234f, Color(0xFFE6B398)),
//            Product(R.drawable.bag3, "Your bag name", 234f, Color(0xFF5ABBD5)),
//            //Product(R.drawable.bag4, "Your bag name", 234f, Color(0xFFD97B7C)),
//            //Product(R.drawable.bag5, "Your bag name", 234f, Color(0xFFDCAB92)),
//            //Product(R.drawable.bag6, "Your bag name", 234f, Color(0xFF60B2CB)),
//            //Product(R.drawable.bag7, "Your bag name", 234f, Color(0xFF817874)),
//            //Product(R.drawable.bag8, "Your bag name", 234f, Color(0xFFE0CDBB)),
//            //Product(R.drawable.bag9, "Your bag name", 234f, Color(0xFFC0A27A)),
//            //Product(R.drawable.bag10, "Your bag name", 234f, Color(0xFFD9D6D6)),
//            //Product(R.drawable.bag11, "Your bag name", 234f, Color(0xFFAF9F8A)),
//            //Product(R.drawable.bag12, "Your bag name", 234f, Color(0xFFC8A07D))
//        )
//    }
//
//    fun addToCard() {
